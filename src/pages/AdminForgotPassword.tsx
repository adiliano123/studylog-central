    ...
    try {
      const response = await fetch("http://localhost:8080/api/auth/verify-identity", {
        ...
        body: JSON.stringify({
          ...
          identityId: formData.email, // For admin, use email as identity
          role: "ADMIN"
        }),
      });
      ...
      if (response.ok) {
        ...
        toast({
          ...
          description: errorText || "Could not verify your identity. Please check your email.",
          variant: "destructive",
        });
      }
    } catch (error) {
      ...
      <div className="w-full max-w-md space-y-4">
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>
              {step === "verify" 
                ? "Enter and confirm your admin email to verify your identity" 
